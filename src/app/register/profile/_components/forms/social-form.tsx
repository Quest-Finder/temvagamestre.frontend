...
import { useSocialForm } from '../../_hooks'
import texts from '../../_locales/pt-BR.json'
import { socialMediaOptions } from '../../_utils'
                ...
                <Form.Item className='group flex flex-row items-start gap-2'>
                  ...
                  <div className='flex flex-1 flex-col gap-1.5'>
                    <Form.Label className='sr-only'>
                      {SOCIAL_FORM_TEXTS.url.label}
                    </Form.Label>
                    <Form.Control>
                      <Input
                        variant={fieldErrors[social.name] && 'error'}
                        placeholder={`${social.baseUrl}/${SOCIAL_FORM_TEXTS.url.placeholder}`}
                        {...field}
                      />
                    </Form.Control>
                    <Form.Message />
